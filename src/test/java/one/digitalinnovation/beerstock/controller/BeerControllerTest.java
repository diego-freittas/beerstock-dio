...
public class BeerControllerTest {
    ...
    @Test
        // quando um POST é chamado e uma cerveja é cadastrada sem erros.
    ...
    @Test // Verificando se os campos obrigatorios foram preenchidos.
    void whenPOSTIsCalledWithoutRequiredFieldThenAnErrorIsReturned() throws Exception {
        ...
        mockMvc.perform(post(BEER_API_URL_PATH)
                .contentType(MediaType.APPLICATION_JSON)
                .content(asJsonString(beerDTO)))
                .andExpect(status().isBadRequest()); // Retorna erro 400 caso um valor obrigatorio não seja informado.
    }
